 ...
 */
export function isNumber(num, dflt) { return typeof num == "number" ? num : undefined }
 ...
 * @returns {string}
 */
export function isString(str, dflt = "") { return typeof str == "string" ? str : dflt }
...
export function isFunction(callback, dflt) { return typeof callback == "function" ? callback : dflt }
 ...
 */
export function isObject(obj, dflt) { return typeof obj == "object" && obj || dflt }
    ...
    if (typeof val == "boolean") {
        ...
        if (typeof val != "string") {
            ...
            n = val[0] == 't' ? 1 : val[0] == 'f' ? 0 :
                ...
                (f ? parseFloat(val, options?.base || 10) : parseInt(val, options?.base || 10));
        }
    }
